                                ...
                                <div className="flex flex-col gap-3">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <select
                                            ...
                                            className="w-24 px-3 py-2.5 bg-gray-800/80 border-2 border-gray-700/80 rounded-xl text-gray-100 focus:outline-none focus:border-indigo-500/50 transition-colors"
                                        >
